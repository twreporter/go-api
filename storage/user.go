...
func (gs *GormStorage) UpdateUserReadingPostCount(userID string, postID string) (bool, error) {
	tx := gs.db.Begin() // Start the transaction
...
// Update user reading posts count
func (gs *GormStorage) UpdateUserReadingPostTime(userID string, postID string, second int) (error) {
	tx := gs.db.Begin() // Start the transaction
