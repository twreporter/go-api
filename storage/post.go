...
func (m *MongoStorage) GetMetaOfPosts(qs string, limit int, offset int, sort string) ([]models.PostMeta, error) {
	var posts []models.PostMeta
	var embedded = []string{"hero_image", "categories", "tags", "topic_meta", "og_image"}
