...
func (s *gormUserStorage) GetOAuthData(aid sql.NullString) models.OAuthAccount {
...
func (s *gormUserStorage) GetUserDataByOAuth(oac models.OAuthAccount) models.User {
