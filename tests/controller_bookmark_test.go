...
func TestCreateABookmarkOfAUser(t *testing.T) {
	var resp *httptest.ResponseRecorder
	var badBookmarkJSON = `{"slug":"a-mock-article","title":"mock title","style":"article","external":false,"desc": "mock desc","thumbnail":"www.twreporter.org/images/}`

	var bookmarkJSON = `{"slug":"a-mock-article","title":"mock title","style":"article","external":false,"desc": "mock desc","thumbnail":"www.twreporter.org/images/mock-image.jpg"}`
	var bookmarkJSON2 = `{"slug":"www.twreporter.org/a/another-mock-article","title":"another mock title","style":"article","external":false,"desc": "another mock desc","thumbnail":"www.twreporter.org/images/mock-image.jpg"}`
