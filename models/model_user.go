...
type User struct {
	...
	ShouldMergeOfflineDonation bool            `gorm:"column:should_merge_offline_donation_by_identity;type:tinyint(1);default:0" json:"should_merge_offline_donation_by_identity"`
}
