...
// TODO(babygoat): migrate to a individual package so that we could share between repositories
...
type PayByPrimeDonation struct {
	...
	CustomerServiceNotes null.String `gorm:"type:varchar(256)" json:"customer_service_header"`
}
